 ...
 * @author nadra
 */
public class createsiswa extends javax.swing.JFrame {
    ...
    try {
        c = koneksi.getConnection();
        st = c.createStatement();
        sql = "SELECT id_spp FROM spp"; // Change this query to fetch data from your database table
        rs = st.executeQuery(sql);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(idkelas, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
       c = koneksi.getConnection();
String sql = "INSERT INTO siswa (nisn, nis, nama, id_kelas, no_telp, id_spp) VALUES (?, ?, ?, ?, ?, ?)";
...
st.setString(5, notelp.getText()); // Use notelp here
st.setInt(6, Integer.parseInt(idspp.getSelectedItem().toString()));
...
if (rowsInserted > 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(createsiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new createsiswa().setVisible(true);
            }
        });
    }
